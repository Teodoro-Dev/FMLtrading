          ...
          <div className="mobile-nav-footer">
            ...
            <div className="mobile-nav-social">
              ...
              <div className="mobile-social-links">
                <a href="https://t.me/feelpsfx" className="mobile-social-link" aria-label="Telegram">
                ...
                <a href="https://www.instagram.com/fml.trading/" className="mobile-social-link" aria-label="Instagram">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
