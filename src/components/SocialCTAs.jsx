      ...
      <div className="container">
        <Reveal>
          <header className="section-head">
            <h2>Conecte-se</h2>
            <p>Entre nos nossos canais e evolua com a comunidade exclusiva da FML Trading.</p>
          </header>
        </Reveal>
        ...
        <Reveal>
          <div className="additional-ctas">
            <div className="cta-section">
              ...
              <p>Junte-se à comunidade que está transformando traders em profissionais do mercado</p>
